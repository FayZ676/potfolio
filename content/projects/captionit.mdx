---
title: captionit.ai
description: An innovative, AI-powered mobile app that generates unique, witty, and humorous captions for your images, tailored to your personal style and current trends.
date: "2022-08-01"
url: https://captionit.ai
published: true
---

[![](/captionit.png)](https://captionit.ai)

**Frameworks and Languages**: Python

**Libraries**: FastAPI, Google Cloud Platform, Docker, Kubernetes, Redis, CUDA, Selenium, Hugging Face Transformers, Firestore

In the summer of 2022, along with three friends from distinct universities, we established Aicon, an innovative Artificial Intelligence-centric startup. Our primary purpose revolves around the utilization of AI to generate equitable solutions for commonplace, yet complex issues. Captionit is our first product and my contributions in this endeavor encompass the following tasks.
